...
This project is a fork of [Condition Lab & Triggler](https://github.com/mclemente/fvtt-condition-lab-triggler) and [Combat Utility Belt](https://github.com/death-save/combat-utility-belt).
...
Many thanks to graygeist (Discord) for the idea of using the [Condition Lab & Triggler](https://foundryvtt.com/packages/condition-lab-triggler) module for the Impact and Combat Position token conditions.
